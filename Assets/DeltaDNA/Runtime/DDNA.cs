...
namespace DeltaDNA
{
    ...
    public class DDNA : Singleton<DDNA> {
        ...
        /// Required for Pinpointer signal events.
        /// </summary>
        public string AppleDeveloperID { get; set; }

        /// <summary>
        /// The Apple iTunes Connect store ID for this game.
        /// Required for Pinpointer signal events.
        /// </summary>
        ...
        public void NotifyOnSessionConfigurationFailed() {
            if (OnSessionConfigurationFailed != null) OnSessionConfigurationFailed();
        }

        public void NotifyOnImageCachePopulated() {
            if (OnImageCachePopulated != null) OnImageCachePopulated();
        }

        public void NotifyOnImageCachingFailed(string cause) {
