...
namespace DeltaDNA
{
    ...
    {
        public static readonly string SDK_VERSION = "Unity SDK Translator v0.0.1";

        internal static readonly string ENGAGE_API_VERSION = "4";

        internal static readonly string EVENT_STORAGE_PATH = null;
        internal static readonly string ENGAGE_STORAGE_PATH = null;
        internal static readonly string ACTIONS_STORAGE_PATH = null;
        internal static readonly string LEGACY_SETTINGS_STORAGE_PATH = null;
        internal static readonly string EVENT_TIMESTAMP_FORMAT = "yyyy-MM-dd HH:mm:ss.fff";
        internal static readonly string USERID_URL_PATTERN = null ;
        internal static readonly string COLLECT_URL_PATTERN = null;
        internal static readonly string COLLECT_HASH_URL_PATTERN = null;
        internal static readonly string ENGAGE_URL_PATTERN = null;
        internal static readonly string ENGAGE_HASH_URL_PATTERN = null; 
        ...
        internal Settings()
        {
            ...
            SendGameRunningEveryMinute = true;
        ...
        /// <summary>
        /// Controls whether or not a 'gameRunning' event is sent every minute
        /// </summary>
